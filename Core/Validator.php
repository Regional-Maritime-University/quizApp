...
class Validator
{
    ...
    public static function validateIndexNumber($input)
    {
    ...
    public static function validateEmail($input): mixed
    {
    ...
    public static function validateInputTextNumber($input)
    {
    ...
    public static function validateInputTextOnly($input)
    {
        if (empty($input)) return array("success" => false, "message" => "Input required");
        $user_input = htmlentities(htmlspecialchars($input));
    ...
    public static function validateNumberOnly($input)
    {
        if (empty($input)) return array("success" => false, "message" => "Input required!");
        $user_input = htmlentities(htmlspecialchars($input));
    ...
    public static function validateImage($files)
    {
    ...
    public static function validateYearData($input)
    {
        if (empty($input)) return array("success" => false, "message" => "Input required");
    ...
    public static function validateGrade($input)
    {
